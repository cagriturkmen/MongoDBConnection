...
public class CountryManagement {
	...
	private void init() {
		...
		cities.add(city);
		cities.add(City.builder().name("İstanbul").cityCode("34").population(15462452).altitude(40).latitude(41.015137)
				.longitude(28.979530).build());
		cities.add(City.builder().name("İzmir").cityCode("35").population(4367251).altitude(2).latitude(38.423733)
